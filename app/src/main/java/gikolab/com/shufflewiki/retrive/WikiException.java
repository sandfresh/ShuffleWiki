...
public class WikiException extends Exception
{
	...
	public WikiException(int theCode, String theMessage, Throwable causeThrowable)
	{
		this(theCode, theMessage + " Cause: " + causeThrowable.getMessage());		
	}
	
	public WikiException(int theCode, String theMessage)
	{
		super(theMessage);
		mCode = theCode;
	}

	public WikiException(String theMessage, Throwable cause)
	{
